...
public class SaleExecutor  extends ItemExecutor{

	private static final Logger logger = LoggerFactory.getLogger(SaleExecutor.class);
	
	public SaleExecutor(ServerProcess parent, ServerQueueItem item) {
		super(parent,item);
